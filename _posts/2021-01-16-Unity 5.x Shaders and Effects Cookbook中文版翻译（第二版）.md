...
- **额外内容**<span id = "CAHS_see_also"></span>
  ...
  在反射计算中向量的**点积dot product**扮演着非常重要的角色。我们在 **[第三章]()，理解照明模型** 这个章节中会详细的介绍它是如何工作的以及为什么会广泛的用于很多的着色器中。
...
- **操作步骤**<span id ="CCAYT_how_to_do_it"></span>
  ...
  通过上面的步骤，你就可以在地形中绘制一个圆。你可以通过材质的**查看面板Inspector tab**去改变这个圆的位置，半径和颜色。
...
- **在表面移动这个圆**<span id="CCAYT_move_the_circle"></span>
  ...
  5. 最后把**Radius material**这个材质拖拽到C#脚本中的**Radius Material**中去[是在**查看面板Inspector tab**中]。
